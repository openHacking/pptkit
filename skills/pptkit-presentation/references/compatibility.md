...
| Node.js fallback | `>=20` |
| `@pptkit/core` | exact `0.1.7` in the preview app and starter |
| `@pptkit/pptx-exporter` | exact `0.1.7` in the preview app and starter |
| `@pptkit/presentation-workflow` | exact `0.1.7` in the preview app and starter |
