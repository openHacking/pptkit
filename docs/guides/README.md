...
- [Presentation Skill](presentation-skill.md) — guided intake, source extraction, curated themes, editable PPTX output, and quality checks for ordinary agent users.
