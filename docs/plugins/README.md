...
The repository's `pptkit-presentation` Agent Skill is a higher-level workflow built only on public package APIs; it is not a PPTKit plugin API or registration mechanism.
